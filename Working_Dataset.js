...
Retrieve the dataset from https://raw.githubusercontent.com/OpenKitten/Mongo-Assets/master/primer-dataset.json and save to a file named primer-dataset.json.
2
...
similar to those found in the bash shell or in Emacs. For example, you can use the <uparrow> and the <down-arrow> to retrieve operations from its history.
